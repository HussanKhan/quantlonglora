...
model = AutoModelForCausalLM.from_pretrained(model_id, device_map='auto', low_cpu_mem_usage=True, torch_dtype=torch.float16) # we load the model in fp16 on purpose
